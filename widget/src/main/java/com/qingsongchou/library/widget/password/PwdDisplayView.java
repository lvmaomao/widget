package com.qingsongchou.library.widget.password;
...
//        radius = resources.getDimensionPixelOffset(R.dimen.default_pwd_view_radius);
        radius = 20;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //draw inner color
        innerPaint.setColor(isLock() ? 0xfff8f8f8 : Color.WHITE);
    ...
    public void addPassword(String text) {
        ...
        invalidate();
        if(hasFullPassword() && listener != null) {
            listener.onActionFullPassword();
        }
    }
