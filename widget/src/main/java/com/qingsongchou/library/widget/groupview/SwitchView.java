...
public class SwitchView extends View {
    ...
    public void onShield(int color){
        this.color = color;
        isShield = false;
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(isOn ? color : 0xffe3e3e3);
    ...
    /**
     * if slide_left_in true , the state change to on;
     * if slide_left_in false, the state change to off
     *
     * @param isOpened
     */
