package com.qingsongchou.library.widget.maraquee;
 ...
 */
public class MarqueeLayout<T> extends ViewGroup {
...
//                        mCurrentPosition = 0;
    ...
    public void start() {
        ...
        mIsStart = true;
        mTimer = new Timer();
        mTimer.schedule(new SwitchTimerTask(), 0, mSwitchTime);
    }
    ...
    public void setAdapter(MarqueeLayoutAdapter<T> adapter) {
