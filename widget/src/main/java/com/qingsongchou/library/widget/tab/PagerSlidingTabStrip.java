...
package com.qingsongchou.library.widget.tab;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int mTabSelectTextSize = 15;
    ...
    private void configTab() {
        ...
        if (count <= 4) {
            isExpandTabs = true;
            mTabLayoutParams.weight = 1.0f;
            notifyDataSetChanged();
        } else {
            isExpandTabs = false;
            mTabLayoutParams.weight = 0;
            mTabLayoutParams.width = LinearLayout.LayoutParams.WRAP_CONTENT;
//            mTabLayoutParams.rightMargin = dipToPx(getContext(), 4);
//            mTabLayoutParams.leftMargin = dipToPx(getContext(), 18);
            notifyDataSetChanged();
        }
//        scrollLeft();
    }
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            v.setPadding(dipToPx(getContext(),18), v.getPaddingTop(), dipToPx(getContext(),4), v.getPaddingBottom());
